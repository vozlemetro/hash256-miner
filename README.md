...
```
This installs CUDA, dependencies, clones and builds the miner automatically.
...
<details>
<summary><b>Manual install (if you prefer step by step)</b></summary>
...
### Установка (Windows) — автоматическая

1. Установите WSL2 — откройте **PowerShell от имени администратора**:
```powershell
wsl --install -d Ubuntu-22.04
```
...
bash <(curl -s https://raw.githubusercontent.com/vozlemetro/hash256-miner/main/install.sh)
```
Скрипт сам установит CUDA, зависимости, скачает и соберёт майнер.
...
<details>
<summary><b>Ручная установка (если хотите пошагово)</b></summary>
